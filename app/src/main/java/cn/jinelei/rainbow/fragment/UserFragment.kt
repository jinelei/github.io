...
class UserFragment : Fragment() {
    ...
    fun initView(view: View) {
        ...
        var listAdapter = ListMenuViewAdapter(myDataset)
...
class ListMenuItem(var callback: View.OnClickListener, var title: String, var resId: Int)
...
class ListMenuViewAdapter(var data: List<ListMenuItem>) :
    ...
    override fun onBindViewHolder(holder: ListMenuItemViewHolder, pos: Int) {
        val menu = data[pos]
        holder.icon.setImageResource(menu.resId)
